...
namespace plexerCode {
	...
	public:
		...
		static Process* getProcessByPid(PC_ACCESS_TYPE desiredAccess,PC_PID pid);
	...
	private:
		...
		static bool reallocPidsBuffer(unsigned long& buffSize, std::vector<unsigned long>* pidsVector, PC_PID*& pidsArray, PC_PID bytesReturned);
